package ru.cepu.feedback_service.config;
...
@Configuration
@EnableMongoRepositories("ru.cepu.feedback_service.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("ru.cepu.feedback_service.config.dbmigrations");
