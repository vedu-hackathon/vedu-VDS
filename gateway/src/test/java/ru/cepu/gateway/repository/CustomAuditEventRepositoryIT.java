package ru.cepu.gateway.repository;

import ru.cepu.gateway.GatewayApp;
import ru.cepu.gateway.config.Constants;
import ru.cepu.gateway.config.audit.AuditEventConverter;
import ru.cepu.gateway.domain.PersistentAuditEvent;
...
import static ru.cepu.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
