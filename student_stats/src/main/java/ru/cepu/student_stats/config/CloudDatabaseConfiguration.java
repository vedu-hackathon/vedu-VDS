package ru.cepu.student_stats.config;
...
@Configuration
@EnableMongoRepositories("ru.cepu.student_stats.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("ru.cepu.student_stats.config.dbmigrations");
