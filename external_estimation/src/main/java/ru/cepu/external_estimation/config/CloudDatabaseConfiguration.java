package ru.cepu.external_estimation.config;
...
@Configuration
@EnableMongoRepositories("ru.cepu.external_estimation.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("ru.cepu.external_estimation.config.dbmigrations");
